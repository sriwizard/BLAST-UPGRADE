...
Make sure you are using the latest version of BLAST
...
Unlimited and super-fast blasting
International blasting available
Call blasting
Frequent updates
Automatic updating mechanism
Easy to use and embed in code
Usage:
Run these commands to run BLAST-UPGRADE
...
pkg install git
pkg install python
git clone https://github.com/sriwizard/BLAST-UPGRADE.git
cd BLAST-UPGRADE
chmod +x Blast.sh
./Blast.sh
> For Linux:
