...
W='\033[0m'
# The Credit For This Code Goes To sriwizard 
...
def banner():
    ...
    logo="""                                                  
                     ...
                     __                __                                     __ 
                    |  \              |  \                                   |  \
  _______   ______   \$$ __   __   __  \$$ ________  ______    ______    ____| $$
 /       \ /      \ |  \|  \ |  \ |  \|  \|        \|      \  /      \  /      $$
|  $$$$$$$|  $$$$$$\| $$| $$ | $$ | $$| $$ \$$$$$$$$ \$$$$$$\|  $$$$$$\|  $$$$$$$
 \$$    \ | $$   \$$| $$| $$ | $$ | $$| $$  /    $$ /      $$| $$   \$$| $$  | $$
 _\$$$$$$\| $$      | $$| $$_/ $$_/ $$| $$ /  $$$$_|  $$$$$$$| $$      | $$__| $$
...
def checkinternet():
    ...
    if res:
        ...
        print('\t\BLAST-UPGRADE Will Stop Now...\n\n')
        banner()
        exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update Blast')
        ...
        print("==================================================================")
        print("                BLASTING in progress, please wait !!               ")
        print("     Please keep your data connection active during blasting !!    ")
        print("==================================================================")
        ...
        print("            This Bomber Was Created By sriwizard !!              ")
        print("==================================================================")
        try:
...
def update():
    stuff_to_update = ['blaster.py', '.version']
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/sriwizard/BLAST-UPGRADE/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen(
    "https://raw.githubusercontent.com/sriwizard/BLAST-UPGRADE/master/.version").read().decode('utf-8')
verl = ''
try:
...
print('\n\n\t\t\tStarting BLAST-UPGRADE...\n\n')
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/sriwizard/BLAST-UPGRADE/master/.notify").read().decode('utf-8')
...
try:
    ...
    type = 0
if type == 1:
    nm = int(input("Enter Number of Calls To Send(Maximum 250): "))
    if nm > 250:
        print("\t\tYou Have Entered " + str(nm) +
              ".\n\tNormalizing Value To 250")
        nm = 250
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tBLAST-UPGRADE Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
    print("\n\nPlease Remember That This Is in Experimental Stage And Is Incredibly Fast...")
    t = [None] * nt
    print(random.choice(colors))
    print("\n\n==================================================================")
    print("                Gearing Up Blaster, please wait !!               ")
